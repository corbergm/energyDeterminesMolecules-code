...
zeiselAll = readtable('mRNAData_Zeisel_2015.txt');
...
[~, ~, perezDendr]                   = xlsread('mRNAData_Perez_2021.xlsx','Dataset S3 - Dendrites');
[~, ~, perezSoma]                    = xlsread('mRNAData_Perez_2021.xlsx','Dataset S3 - Somata');
